...
--Metadata
	...
	EXEC sys.sp_addextendedproperty 
     @name = N'Desnormalizacion', 
     @value = N'La dimension Materia provee una vista desnormalizada de la tabla Materia en una sola dimensi�n para un modelo modelo estrella', 
     @level0type = N'SCHEMA', 
     @level0name = N'Dimension', 
     @level1type = N'TABLE', 
	...
	EXEC sys.sp_addextendedproperty 
     @name = N'Desnormalizacion', 
     @value = N'La dimension Descuento provee una vista desnormalizada de la tabla Descuento en una sola dimensi�n para un modelo modelo estrella', 
     @level0type = N'SCHEMA', 
     @level0name = N'Dimension', 
     @level1type = N'TABLE', 
...
--Transformaci�n en modelo l�gico (mas detalles)
	...
	--DimExamenDetalle_Materia
	ALTER TABLE Dimension.Materia ADD ID_Materia [UDT_PK]
	ALTER TABLE Dimension.Materia ADD ID_Examen [UDT_PK]
	ALTER TABLE Dimension.Materia ADD ID_ExamenDetalle [UDT_PK]
	ALTER TABLE Dimension.Materia ADD NombreMateria [UDT_VarcharCorto]
	ALTER TABLE Dimension.Materia ADD NotaArea [UDT_Decimal5.2]

	--DimDescuento
	ALTER TABLE Dimension.Descuento ADD Descuento [UDT_PK]
	ALTER TABLE Dimension.Descuento ADD Descripcion [UDT_VarcharMediano]
	ALTER TABLE Dimension.Descuento ADD Porcentaje [UDT_Decimal6.2]
