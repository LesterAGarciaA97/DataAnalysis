/*
SCRIPT BD [RepuestosWebDWH-Estrella]
*/

DROP DATABASE IF EXISTS [RepuestosWebDWH-Estrella];

CREATE DATABASE [RepuestosWebDWH-Estrella]
GO

USE [RepuestosWebDWH-Estrella]
GO
...
--Modelado logico			
	...
	ALTER TABLE Dimension.Geografia ADD NombreGeografia [UDT_VarcharCorto]
